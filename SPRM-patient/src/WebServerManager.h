    ...
    <section class="cards-grid">
      ...
      <article class="card bp-card" style="--delay:.16s;">
        ...
        <form data-message="Blood pressure saved.">
          <div class="fields two-col">
            <div class="field"><label for="bp-sys"><span>SYS</span><small>mmHg</small></label><input id="bp-sys" type="number" value="120"></div>
            <div class="field"><label for="bp-dia"><span>DIA</span><small>mmHg</small></label><input id="bp-dia" type="number" value="80"></div>
          </div>
